...
osThreadId taskUartMsgHandle;
osThreadId taskAnalogInputHandle;
osMessageQId queueScreen1Handle;
osMessageQId queueScreen2Handle;
...
int main(void)
{
  ...
  /* Create the queue(s) */
  /* definition and creation of queueScreen1 */
  osMessageQDef(queueScreen1, 16, uint16_t);
  queueScreen1Handle = osMessageCreate(osMessageQ(queueScreen1), NULL);

  /* definition and creation of queueScreen2 */
  osMessageQDef(queueScreen2, 16, uint16_t);
  queueScreen2Handle = osMessageCreate(osMessageQ(queueScreen2), NULL);
  ...
  osThreadDef(taskUartMsg, StartTaskUartMsg, osPriorityIdle, 0, 2000);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOI, ARDUINO_D7_Pin|ARDUINO_D8_Pin|LED_Green_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ARDUINO_D7_Pin ARDUINO_D8_Pin LED_Green_Pin LCD_DISP_Pin */
