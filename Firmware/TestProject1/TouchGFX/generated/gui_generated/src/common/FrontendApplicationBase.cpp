...
#include <gui/openscreen_screen/OpenScreenView.hpp>
...
void FrontendApplicationBase::gotoOpenScreenScreenNoTransition()
{
    transitionCallback = touchgfx::Callback<FrontendApplicationBase>(this, &FrontendApplication::gotoOpenScreenScreenNoTransitionImpl);
    pendingScreenTransitionCallback = &transitionCallback;
}

void FrontendApplicationBase::gotoOpenScreenScreenNoTransitionImpl()
{
    touchgfx::makeTransition<OpenScreenView, OpenScreenPresenter, touchgfx::NoTransition, Model >(&currentScreen, &currentPresenter, frontendHeap, &currentTransition, &model);
}
