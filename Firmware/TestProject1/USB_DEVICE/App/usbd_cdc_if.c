...
/* USER CODE BEGIN PV */
/* Private variables ---------------------------------------------------------*/
#define MaxCommandsInBuffer 10 // Hab added
/* USER CODE END PV */
...
#define APP_RX_DATA_SIZE  200	// Hab Edit was orignally 2048
#define APP_TX_DATA_SIZE  200	// Hab Edit was originally 2048
...
// Hab added this struct / only used here only used once
static struct
{
	int
...
static int8_t CDC_Receive_FS(uint8_t* Buf, uint32_t *Len)
{
  /* USER CODE BEGIN 6 */
	...
	// The 3 lines that follow were original to what was already here... I comment out and use what was added above
